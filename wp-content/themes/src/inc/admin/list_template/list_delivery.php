	...
	<table class="display">
		...
		?>
			<tr id="delivery-data-<?php echo $b_value->delivery_id; ?>">
				...
				<td class="center">
					<span>
						<a href="<?php echo admin_url('admin.php?page=bill_delivery').'&delivery_id='.$b_value->delivery_id.'&action=update'; ?>" class="action-icons c-edit" data-bill-id="<?php echo $b_value->id; ?>" title="Edit">Edit</a>
					</span>
					<span><a class="action-icons c-delete delivery_delete" href="#" title="delete" data-id="<?php //echo $stock_value->id; ?>" data-roll="1">Delete</a></span>
				</td>
			</tr>
		<?php
				}
