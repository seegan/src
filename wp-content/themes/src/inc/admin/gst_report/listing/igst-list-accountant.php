...
<div class="search_bar igst_report_filter">
    ...
    <select name="slab" class="slab">
        ...
        <option value="5.00" <?php echo ($report->slab == '5.00') ? 'selected' : '' ?>>5 %</option>
        <option value="12.00" <?php echo ($report->slab == '12.00') ? 'selected' : '' ?>>12 %</option>
        <option value="18.00" <?php echo ($report->slab == '18.00') ? 'selected' : '' ?>>18 %</option>
        <option value="28.00" <?php echo ($report->slab == '28.00') ? 'selected' : '' ?>>28 %</option>
    </select>
...
<div class="widget-content module table-simple list_customers">
    <?php include( get_template_directory().'/inc/admin/gst_report/ajax_loading/igst-list-accountant.php' ); ?>
</div>
