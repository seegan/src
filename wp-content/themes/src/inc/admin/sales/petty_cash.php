...
<div style="width: 100%;">
	<ul class="icons-labeled">
		<li><a href="javascript:void(0);" id="my-button" class="popup-add-petty-cash"><span class="icon-block-color add-c"></span>Add Petty Cash</a></li>
	</ul>
</div>
...
<div class="search_bar petty_cash_filter">
	<label>Page :</label>
