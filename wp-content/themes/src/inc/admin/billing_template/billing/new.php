                        ...
                        <div class="div-table-row">
                            ...
                            <div class="div-table-col sale-price total-price">
                                <div class="actual_total">
                                    <input  type="text" name="actual_price" class="actual_price text-right"  tabindex=-1  value="0.00" readonly="">
                                </div>
                            </div>
                        ...
                        <div class="div-table-row">
                            ...
                            <div class="div-table-col sale-price">
                                <div class="round_price">
                                    <input  type="text" name="round_off_text" class="round_off_text text-right"  tabindex=-1 value="0.00" readonly="">
                                </div>                             
                            </div>
                            <div class="div-table-col option-delete">
                            </div>
                        ...
                        <div class="div-table-row">
                            ...
                            <div class="div-table-col sale-price">
                                <div class="final_total_price">
                                    <input  type="text" name="final_total" class="final_total text-right"  tabindex=-1 value="0.00" readonly="">
