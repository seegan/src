		...
		<div class = "print_content">
			<div class = "print_header">
				<div style="width: 320px; margin: 0 auto; padding: 5px 0px; height: 75px;">
					<div class="header_inside">
						<img src="<?php echo get_template_directory_uri().'/inc/images/logo-login.png' ?>"/></div>
					<br/><br/>
				</div>
			</div>
			<div class="info_bar">
			...
			<div class=footer_addr>
				<div style="width: 72%; margin: 0 auto;">
					Saravana Rice Centres - No : 29, Test Nagar, Testing Street, Chennai - 17.
				</div>
			</div>
		</div>
...
if($bill_data['bill_data']->customer_type == 'retail'){
	if($view_from == 'cancel_billing_list'){
