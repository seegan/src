		...
		?>
			<tr id="customer-data-<?php echo $b_value->id; ?>">
				...
				<td class="center">
					...
					<span>
						<a class="bill-delete lot_delete last_list_view" href="#" data-action="sale" title="Cancel Bill" data-id="<?php echo $b_value->id; ?>" data-user="<?php  echo $user = get_current_user_id();?>" data-roll="1">Cancel</a>
					</span>
				</td>
			</tr>
		<?php
